...
class TestUserAddToBasketFromProductPage:
    ...
    def setup(self, browser):
        ...
        f = faker.Faker()  # Create test email
        self.page.register_new_user(f.email(), "p@ssw0rd123")
        self.page.should_be_allert_success_registration()
...
def test_cart_value_after_adding_a_product(browser):
    link = "http://selenium1py.pythonanywhere.com/ru/catalogue/the-shellcoders-handbook_209/?promo=newYear"
    page = ProductPage(browser, link)
    page.open()
    page.click_button_add_to_busket()
